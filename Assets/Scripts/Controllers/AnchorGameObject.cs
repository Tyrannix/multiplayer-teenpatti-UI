    ...
    void UpdateAnchor()
    {
        switch (anchorType)
        {
            case AnchorType.BottomLeft:
                SetAnchor(CameraController.Instance.BottomLeft);
                break;
            case AnchorType.BottomCenter:
                SetAnchor(CameraController.Instance.BottomCenter);
                break;
            case AnchorType.BottomRight:
                SetAnchor(CameraController.Instance.BottomRight);
                break;
            case AnchorType.MiddleLeft:
                SetAnchor(CameraController.Instance.MiddleLeft);
                break;
            case AnchorType.MiddleCenter:
                SetAnchor(CameraController.Instance.MiddleCenter);
                break;
            case AnchorType.MiddleRight:
                SetAnchor(CameraController.Instance.MiddleRight);
                break;
            case AnchorType.TopLeft:
                SetAnchor(CameraController.Instance.TopLeft);
                break;
            case AnchorType.TopCenter:
                SetAnchor(CameraController.Instance.TopCenter);
                break;
            case AnchorType.TopRight:
                SetAnchor(CameraController.Instance.TopRight);
                break;
        }
    }
